...
//                                  n = 01234567890123456789012345678901
                                     // b  b  b  b  b  b  b  b  b  b  b  // 10,000,000,000,000,000,000,000,000,000,000
#define BREAK_THOUSANDS   0x49249249248ul
...
#define BREAK_INDIVIDUAL  0x00000018 // b  bb                            // 100,0,000
	...
	unsigned long break_numbers;  // which digits to break the number into thousands, millions, etc (Hindi has 100,000 not 1,000,000)
	int max_roman;
	int min_roman;
	int thousands_sep;
	int decimal_sep;
